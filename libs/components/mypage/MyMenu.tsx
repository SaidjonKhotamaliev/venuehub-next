...
const MyMenu = () => {
	...
	if (device === 'mobile') {
		...
		return (
			<Stack width={'100%'} padding={'30px 24px'} flexDirection={'row'} justifyContent={'space-between'}>
						...
						<List className={'sub-section'}>
							{user.memberType === 'AGENT' && (
								<>
									...
									<ListItem className={pathname === 'addEquipment' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'addEquipment' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
												{category === 'addEquipment' ? (
													<img className={'com-icon'} src={'/img/icons/whiteTab.svg'} alt={'com-icon'} />
												) : (
													<img className={'com-icon'} src={'/img/icons/newTab.svg'} alt={'com_icon'} />
												)}
									...
									<ListItem className={pathname === 'myEquipments' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
